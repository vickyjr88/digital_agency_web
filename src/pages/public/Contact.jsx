  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      value: 'hello@dexter.co',
      link: 'mailto:hello@dexter.co'
    },
    {
      icon: Phone,
      title: 'Phone',
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full px-6 py-3 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
                  >
                    {submitting ? (
                      <>Sending...</>
                    ) : (
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Prefer to reach out directly? You can contact us through any of the following channels.
              </p>
